                        ...
                        <div key={index} class="col-md-3 py-3 py-md-0">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <h2> &#x20b9;{item.product_lowest_price} <span><li class="fa-solid fa-cart-shopping"></li></span></h2>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body ">
                                    ...
                                    <p class="text-center">Category : {modal.product_category}</p>
                                    {/* <h2> &#x20b9;{modal.product_lowest_price} <span><li class="fa-solid fa-cart-shopping"></li></span></h2> */}
                                </div>
